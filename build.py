...
ninja.rule('cc1_263',
           command='./bin/cc1-psx-26 -O2 -g0 -G0 -funsigned-char $in -o $out',
...
ninja.rule('link',
           'mipsel-linux-gnu-ld -T main.ld syms.txt config/undefined_funcs_auto.us.main.txt config/undefined_syms_auto.us.main.txt $in -o $out')
