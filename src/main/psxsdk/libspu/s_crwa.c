...
INCLUDE_ASM("main/nonmatchings/psxsdk/libspu/s_crwa", _spu_FsetRXXa);
...
INCLUDE_ASM("main/nonmatchings/psxsdk/libspu/s_crwa", _spu_FsetDelayW);

INCLUDE_ASM("main/nonmatchings/psxsdk/libspu/s_crwa", _spu_FsetDelayR);

INCLUDE_ASM("main/nonmatchings/psxsdk/libspu/s_crwa", _spu_FwaitFs);
