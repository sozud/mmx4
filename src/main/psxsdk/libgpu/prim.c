...
INCLUDE_RODATA("main/nonmatchings/psxsdk/libgpu/prim", D_80011C74);
...
INCLUDE_ASM("main/nonmatchings/psxsdk/libgpu/prim", SetDrawTPage);

INCLUDE_ASM("main/nonmatchings/psxsdk/libgpu/prim", SetDrawMove);

INCLUDE_ASM("main/nonmatchings/psxsdk/libgpu/prim", SetDrawLoad);
