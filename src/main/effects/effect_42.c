...
{
    arg0->ext.effect_42.owner.main->ext.main_73.effect.bytes.unk8E = 0;
    switch (arg0->ext.effect_42.owner.main->ext.main_73.effect.bytes.object_id) {
    case 0:
    case 1:
    case 2:
        arg0->state = 1;
        break;
    default:
        arg0->ext.effect_42.owner.main->ext.main_73.effect.bytes.state = 1;
        arg0->state = 2;
        break;
    }
}
...
{
    if (g_Player.unkBC == 0) {
        arg0->ext.effect_42.owner.main->ext.main_73.effect.bytes.state = 0;
