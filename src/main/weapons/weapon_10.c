...
INCLUDE_ASM("main/nonmatchings/weapons/weapon_10", func_800938C0);
...
INCLUDE_ASM("main/nonmatchings/weapons/weapon_10", func_80093C08);

INCLUDE_ASM("main/nonmatchings/weapons/weapon_10", func_80093C54);
