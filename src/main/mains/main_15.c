...
INCLUDE_ASM("main/nonmatchings/mains/main_15", func_8004DEA0);

INCLUDE_ASM("main/nonmatchings/mains/main_15", func_8004DF40);
...
INCLUDE_ASM("main/nonmatchings/mains/main_15", func_8004E810);
