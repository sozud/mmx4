...
INCLUDE_ASM("main/nonmatchings/mains/main_45", func_80065B8C);
...
INCLUDE_ASM("main/nonmatchings/mains/main_45", func_80066580);
...
INCLUDE_ASM("main/nonmatchings/mains/main_45", func_8006692C);
