...
static void main_24_trail(struct MainObj* arg0, u8 subtype, u8 facing)
{
    struct MiscObj* misc;

    if ((++arg0->ext.main_24.unk80 & 3) != 0)
        return;
    misc = find_free_misc_obj();
    if (misc == NULL)
        return;
    ...
    misc->x_pos.val = arg0->x_pos.val;
    misc->y_pos.val = arg0->y_pos.val;
    misc->ext.misc_7.position = &arg0->x_pos;
    misc->state = 0;
    misc->unk15 = facing;
}
...
void func_80056C18(struct MainObj* arg0)
{
    func_8002B718(MOVING_OBJECT(arg0));
    func_80015DC8(ANIMATED_OBJECT(arg0));
    main_24_trail(arg0, 0, arg0->unk15);
    if (--arg0->unk7C == 0) {
        func_80015D60(arg0, 1);
        arg0->unk6 = 1;
    }
...
void func_80056DB4(struct MainObj* arg0)
{
    func_8002B694(ANIMATED_OBJECT(arg0));
    func_80015DC8(ANIMATED_OBJECT(arg0));
    main_24_trail(arg0, 1, arg0->unk15 ^ 0x40);
    if (--arg0->unk7C != 0)
        return;
    arg0->unk2C = 0;
    arg0->unk24 = (arg0->unk2 & 3) < 2 ? -0x20000 : 0x20000;
    arg0->unk7C = 1;
    arg0->unk7E = 8;
    arg0->unk6 = 3;
}
...
void func_80056EF4(struct MainObj* arg0)
{
    ...
    arg0->unk7E = --arg0->unk7C == 0 ? 0x7FFF : 8;
}
...
void func_80039570(struct PlayerObj* arg0)
{
    ...
    if (event & 0x80) {
        arg0->animation_step.fields.event = event & 0x7F;
        weapon = func_80036DA0(1, 4, arg0->unk17 == 0x63 ? 0 : 1, NULL);
        if (weapon != NULL)
    ...
    if (arg0->unk17 == 0x63 && arg0->unk8E == 0) {
        if ((arg0->unk88.bytes.collision_flags & 8) == 0) {
            func_80034604(arg0);
            return;
        }
        arg0->unk67 = 0;
        if (func_80034100(arg0) != 0 || func_80033EA4(arg0) != 0 || func_80037290(arg0) != 0 || func_80033494(arg0) != 0)
            return;
